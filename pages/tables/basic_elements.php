...
$vendorname = $age =  $image = "";
$vendornameErr = $ageErr = "";
$vender_name = $vender_mob = $vender_email =  $vender_age = $vender_address = "";
...
*/
    ...
    queryExecute("INSERT INTO add_product (product_name	,product_price,	short_desc	,in_stock,	stock_no,	full_desc)
   VALUES ('" . $name . "','" . $price . "','" . $shortdesc . "','" . $instock . "','" . $stockno . "','" . $fulldesc . "')", "product added");
  }
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($_POST["vender_submit"] == "vender_submit") {
    ...
    $vender_address = test_input($_POST["address"]);


    queryExecute("INSERT INTO add_vender (vender_name	,vender_mob,	vender_email,	vender_age,	vender_address	)
VALUES ('" . $vender_name . "','" . $vender_mob . "','" . $vender_email . "','" . $vender_age . "','" . $vender_address . "')", "vendor insserted");
  }
}
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="D:\HTML Templates\connect-plus-1.0.0\connect-plus-1.0.0\pages\tables\basic-table.php">View Products</a></li>
                <li class="nav-item"> <a class="nav-link" href="D:\HTML Templates\connect-plus-1.0.0\connect-plus-1.0.0\pages\tables\basic-table.php">Ordered Products</a></li>
              </ul>
            </div>
          </li>
        ...
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-description"> Add Product data </p>
            ...
            <div class="card-body">
              <h4 class="card-title">Add A Vender</h4>
              <p class="card-description"> Vender Information </p>
              <form class="forms-sample" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                <div class="form-group">
