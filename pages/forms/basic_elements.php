...
$name = $email = $mobileno = $gender = $website = $agree = $price = $shortdesc = $instock = $stockno = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (($_POST["shortdesc"]) == "") {
        ...
        $shortdesc = ($_POST["name"]);
    }
    //in stock validation
    if (isset($_REQUEST['instock']) && $_REQUEST['instock'] == '0') {
                        ...
                        <div class="input-group">
                          ...
                          <div class="input-group-append">
                            <span class="input-group-text">.00</span>
                                ...
                                <div class="form-group">
                                    <label for="shortdesc">Email Address</label>
                                    <input type="text" class="form-control" id="price" name="price" placeholder="Enter Amount In Rs.">
                                    <span class="error" style="color: red;">* <?php echo $sdescErr; ?> </span>
                                </div>
                                <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="stockno">Age</label>
                                    <input type="text" class="form-control" id="stockno" placeholder="Stocks Available(Nos.)" name="stockno">
                                    <span class="error" style="color: red;">* <?php echo $stocknoErr; ?> </span>
                                </div>
                                <div class="form-group">
                                    <label>Select The Product Which You want to sell?</label>
                                    <input type="file" name="img[]" class="file-upload-default">
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image">
                                        <span class="input-group-append">
